...
import Method2DatasetBuilder from "./pages/Method2DatasetBuilder";
...
const navItems = [
  ...
  { to: "/method2", label: "数据集制作（SITK）", description: "基于 SimpleITK 的配准与数据集制作流程" },
];
      ...
      <div className="app-shell">
        <aside className="app-sidebar">
          ...
          <div className="app-sidebar-footer">
            <div>医学图像生成与导出工具</div>
            <div>Spring backend · Flask removed</div>
          </div>
        </aside>
        ...
        <main className="app-main">
          <Routes>
            ...
            <Route path="/method2" element={<Method2DatasetBuilder />} />
          </Routes>
        </main>
      </div>
    </BrowserRouter>
